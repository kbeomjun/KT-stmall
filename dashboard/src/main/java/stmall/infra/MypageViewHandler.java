...
public class MypageViewHandler {
    ...
    public void whenOrderPlaced_then_CREATE_1(
        ...
        try {
            ...
            mypage.setCustomerId(Long.valueOf(orderPlaced.getCustomerId()));
            mypage.setItemId(Long.valueOf(orderPlaced.getItemId()));
    ...
    public void whenDeliveryCompleted_then_UPDATE_1(
        ...
        try {
            ...
            if (mypageOptional.isPresent()) {
                ...
                mypage.setDeliveryStatus(ORDERCOMPLETED);
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
        } catch (Exception e) {
    ...
    public void whenDeliveryReturned_then_UPDATE_2(
        ...
        try {
            ...
            if (mypageOptional.isPresent()) {
                Mypage mypage = mypageOptional.get();
                // view 객체에 이벤트의 eventDirectValue 를 set 함
                mypage.setDeliveryStatus(ORDERDELIVERED);
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
        } catch (Exception e) {
